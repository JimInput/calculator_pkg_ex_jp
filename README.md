...
[![PyPI version](https://badge.fury.io/py/calculator_pkg_ex_jp.svg)](https://badge.fury.io/py/calculator_pkg_ex_jp)
![PyPy](https://img.shields.io/badge/PyPy-7.3.17-blue)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/calculator_pkg_ex_jp)](https://pypi.org/project/calculator_pkg_ex_jp/)
![Tests](https://github.com/jfuruness/calculator_pkg_ex_jp/actions/workflows/tests.yml/badge.svg)
...
```python
from calculator_pkg_ex_jp import FileCalculator
...
```bash
pip3 install calculator_pkg_ex_jp
```
...
```bash
git clone https://github.com/jfuruness/calculator_pkg_ex_jp.git
cd calculator_pkg_ex_jp
pip3 install -e .[test]
pre-commit install
```
...
```
cd calculator_pkg_ex_jp
pytest calculator_pkg_ex_jp
ruff check calculator_pkg_ex_jp
ruff format calculator_pkg_ex_jp
mypy calculator_pkg_ex_jp
```
